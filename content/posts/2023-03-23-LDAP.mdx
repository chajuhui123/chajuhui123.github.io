---
title: "LDAP, 중앙관리 및 검색에 최적화된 디렉터리 서비스"
date: 2023-03-23
tags: ["Infra"]
image: "/images/frontmatter/2.png"
---
...
![그룹 생성 1](/images/legacy/ldap_screenshot_0.png)

LDAP 그룹을 생성합니다. root entry 경로에서 New Entry 를 선택해 Entry를 추가합니다.

![그룹 생성 2](/images/legacy/ldap_screenshot_1.png)

![그룹 생성 3](/images/legacy/ldap_screenshot_2.png)

![그룹 생성 4](/images/legacy/ldap_screenshot_3.png)

OrganizationalUnit 이라는 Object 를 생성해줍니다.

![그룹 생성 5](/images/legacy/ldap_screenshot_4.png)

RDN을 `ou(Organizational Unit)`로 설정하고 그룹(부서)명을 입력합니다.

![그룹 생성 6](/images/legacy/ldap_screenshot_5.png)
...
![유저 생성 1](/images/legacy/ldap_screenshot_6.png)

organizationalPerson 이라는 Object 를 생성해줍니다.

![유저 생성 2](/images/legacy/ldap_screenshot_7.png)
...
![검색 1](/images/legacy/ldap_screenshot_8.png)

왼쪽 search 메뉴에서 New Search를 선택해 검색 기능을 생성할 수 있습니다.

![검색 2](/images/legacy/ldap_screenshot_9.png)
